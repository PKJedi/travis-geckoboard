...
const fetchRepository = function(url) {
...
//+ map(fetchRepository) ::   [Url] -> [Observable(Repository)]
//+ Rx.Observable.zipArray ::          [Observable(Repository)] -> Observable([Repository])
//---------------------------------------------------------------------------------------
//+ travis ::                 [Url]              ->                Observable([Repository])
module.exports = compose(Rx.Observable.zipArray, map(fetchRepository));
